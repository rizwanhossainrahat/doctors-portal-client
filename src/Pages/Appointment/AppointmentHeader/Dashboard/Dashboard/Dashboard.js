...
function Dashboard(props) {
  ...
  const drawer = (
    <div>
      <Toolbar />
      <Divider />
      <Link style={{textDecoration:'none'}} to='/appointment'><Button  variant="text" >Appointment</Button></Link>
      ...
      <Link style={{textDecoration:'none'}} to='adddoctor'><Button   variant="text">Add Doctor</Button></Link>
      </Box>
      }
      <List>
